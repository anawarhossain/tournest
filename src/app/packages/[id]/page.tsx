      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mt-8">
        ...
        <div>
          <div className="sticky top-24 rounded-2xl border border-neutral-200 p-5">
            ...
            <button
              type="button"
              onClick={() => setBookingNote("Online booking & payment is launching in the next update. Stay tuned!")}
              className="mt-4 w-full rounded-xl bg-teal py-2.5 text-sm font-semibold text-white hover:opacity-90"
            >
              Book Now
            </button>

            {bookingNote && <p className="mt-3 text-xs text-neutral-500">{bookingNote}</p>}
          </div>
        </div>
      </div>
