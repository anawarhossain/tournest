        ...
        <div className="lg:col-span-2">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-3 text-sm text-neutral-500">
            ...
            <span className="flex items-center gap-1.5">
              ...
              {pkg.averageRating.toFixed(1)} ({pkg.totalReviews} review
              {pkg.totalReviews === 1 ? "" : "s"})
            </span>
          </div>
              ...
              <div>
                ...
                <ul className="space-y-1.5">
                  {pkg.specifications.included.map((item, i) => (
                    ...
                    >
                      <FaCircleCheck
                        className="mt-0.5 text-teal shrink-0"
                        size={13}
                      />{" "}
                      {item}
                    </li>
          ...
          <section className="mt-10 pt-8 border-t border-neutral-200">
            ...
            {session ? (
              ...
              <p className="text-sm text-neutral-500 mb-6">
                <a
                  href={`/login?returnUrl=/packages/${id}`}
        ...
        <div>
          <div className="sticky top-24 rounded-2xl border border-neutral-200 p-5">
            ...
            <p className="mt-3 text-xs text-neutral-400">
              Charged in USD (Stripe doesn&apos;t support BDT settlement) — the
              price above shows the BDT equivalent.
            </p>
          </div>
        </div>
      </div>
